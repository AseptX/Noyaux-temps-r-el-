...
// Il faut appeler cette tâche lorsque l'on a une interruption de réception de caractère
// (en l'occurence, c'est fait dans le fichier main.c : HAL_UART_RxCpltCallback)
